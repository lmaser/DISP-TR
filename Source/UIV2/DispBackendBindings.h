...
{
class DispBackendBindings final : public SimpleUIV2::SimpleJuceBackend,
                                  public Modulation::UI::ModulationUiBackend
{
public:
    explicit DispBackendBindings(DisperserAudioProcessor& processorToUse) noexcept;
...
private:
    DisperserAudioProcessor& processor;
	DisperserAudioProcessor::PhaseContourTelemetry phaseContourTelemetry;
};
}
